...
\begin{document}
  ...
  Разработчик приложений для ОС Android. Опыт разработки~--- около 3 лет.
  ...
  \section*{Навыки и умения}
    ...
    \subsection*{Языки программирования}
      ...
      \begin{itemize}
        ...
        \item JavaScript~--- автоматизация, расширения для Google Chrome.
  ...
  \section*{Профессиональный опыт}
    ...
    \subsection*{Университет, открытое ПО и иные проекты}
      ...
      Разработал несколько небольших вспомогательных проектов.
